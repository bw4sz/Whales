...
r<-(m-max(m[]))*100
ras2<-raster(xmn=-40,xmx=40,ymn=-40,ymx=40,resolution=1,crs=NA)
r2<-setExtent(r,ras2)
habitat<-resample(r2,ras2)
#color ramp
co<-colorRampPalette(c('midnight blue', 'blue', 'skyblue'))
...
mxy<-melt(mxy,id.vars=c("x","y","Step","State"))
