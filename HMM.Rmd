...
ggplot(dxy,aes(x=x,y=y)) + geom_point(size=2,col='black') + geom_path(aes(col=State,group=1),size=2)  + theme_bw() 
```
...
ggplot(mxy,aes(x=x,y=y)) + geom_point(size=2,col='black') + geom_path(aes(col=State,group=L1),size=2)  + theme_bw()  + ggtitle("Multiple trajectories")
```
