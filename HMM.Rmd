...
ggplot()+geom_path(data=dxy, aes(x=x, y=y,col=LFeeding),size=2) + scale_color_continuous(low='blue',high='red') + labs(col="Probability of Feeding State")
```

##Autocorrelation in behavior

```{r}
ggplot(data=dxy,aes(x=as.numeric(step),y=LFeeding,col=ocean)) + geom_line(aes(group=1),size=2.5) + labs("Liklihood Feeding") + theme_bw() + scale_color_continuous(low='light blue',high='black') + labs(x="Time Step",y="Liklihood of Feeding")
```
