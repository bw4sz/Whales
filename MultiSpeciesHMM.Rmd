...
```{r}
mxy<-lapply(1:3,function(x) traj(gamma=gamma,theta=theta,a1=a1,habitat=habitat,beta=beta))
...
p<-coda.samples(model=jags,n.iter=500,thin=2,variable.names=c("theta","gamma","alpha","beta"))
```
