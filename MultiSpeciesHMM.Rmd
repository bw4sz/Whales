...
#paramters to track
pt<-c("theta","gamma","alpha","beta","phi","lalpha","lbeta")

if(newModel){
  jagM<-jags(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=30000,n.burnin=20000,n.thin=5)
}
