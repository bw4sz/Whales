...
if(newModel){
  habitat<-raster(xmn=-100,xmx=100,ymn=-100,ymx=100,resolution=0.25,crs=NA,vals=runif(640000,0,1))
}
...
p<-coda.samples(model=jags,n.iter=5000,thin=5,variable.names=c("theta","gamma","alpha","beta"))
```
