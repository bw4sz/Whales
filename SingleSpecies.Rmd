...
mxy<-mxy[mxy$Animal %in% c("121211","123224","112699"),]
...
gamma2prior<-data.frame(Draw=1:todraw,par='gamma[2]',value=rbeta(todraw,0,0.5),parameter='gamma',Behavior=2,Estimate="Prior")
