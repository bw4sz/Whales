...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=15000,n.burnin=13000,n.thin=4,DIC=FALSE))
}
...
gamma2prior<-data.frame(Draw=1:todraw,par='gamma[2]',value=rbeta(todraw,5,2) * runif(todraw,0,0.75),parameter='gamma',Behavior=1,Estimate="Prior")
