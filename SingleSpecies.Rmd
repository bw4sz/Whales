...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=40000,n.burnin=40000-2000,n.thin=2,DIC=FALSE))
}
...
ggmap(temp,darken=0.2) +  geom_point(data=krill,aes(x=GridMidpointDegreeLon,y=GridMidpointHalfDegreeLat,size=C1KRIcatchKG)) + scale_fill_continuous(low="blue",high="red") + scale_color_continuous(low="white",high="black") + labs(fill="Probability of Feeding", size="Krill Catch") + geom_tile(data=feedmap,aes(x=x, y=y,fill=layer),alpha=0.7) + scale_size_continuous(range=c(0,8)) 
```
