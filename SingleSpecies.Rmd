...
#grab two animals
mxy<-mxy[mxy$Animal %in% c("131132","112737","131156","12326","112705","154187","121210","131134"),]
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=13000,n.burnin=10000,n.thin=5,DIC=FALSE))
}
...
```{r}
#notify end of run
send.mail(from="benweinstein2010@gmail.com",to="benweinstein2010@gmail.com",subject=paste("Run Completed at",Sys.time()),body="")
