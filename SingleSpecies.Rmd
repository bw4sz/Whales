...
ggplot()  + geom_linerange(data=nulld,col="black",aes(x=Unit,ymax=upper,ymin=lower),size=1) + coord_flip() + theme_bw() + labs(y="Hours") + labs(x="Unit",y="Observation Days") +geom_point(data=ttime_unit,col="grey50",size=3,aes(x=Unit,y=Days))
ggsave("Figures/RandomizationI.jpeg",height=3,width=5)
```
