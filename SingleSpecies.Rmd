...
gamma1prior<-data.frame(Draw=1:todraw,par='gamma[1]',value=runif(todraw,0.3,1),parameter='gamma',Behavior=1,Estimate="Prior")

gamma2prior<-data.frame(Draw=1:todraw,par='gamma[2]',value=runif(todraw,0,0.3),parameter='gamma',Behavior=2,Estimate="Prior")
