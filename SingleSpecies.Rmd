...
p<-coda.samples(model=jags,n.iter=1000,thin=5,variable.names=c("theta","gamma","alpha","beta","phi","lalpha","lbeta"))
```
...
ggmap(m)+geom_path(data=mxy, aes(x=x, y=y,col=phi,group=Animal),size=.5) + scale_color_continuous(low='blue',high='red') + labs(col="Probability of Feeding")
