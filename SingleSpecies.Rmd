...
mxy<-mxy[mxy$Animal %in% c("131144","154186","123224"),]
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=50000,n.burnin=48000,n.thin=4,DIC=FALSE))
}
