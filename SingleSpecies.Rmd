...
#mxy<-mxy[mxy$Animal %in% c("131132","112737","131156","112703","121211","131132","112737"),]
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=40000,n.burnin=39000,n.thin=4,DIC=FALSE))
}
