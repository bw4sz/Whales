...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=0,n.burnin=2000,n.thin=8,DIC=FALSE))
}
...
Areas<-data.frame(c("Gerlache Strait"))
Lon<-c(-62.333)
Lat<-c(-64.5)
