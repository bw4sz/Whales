...
```{r}
ggmap(m)+ geom_polygon(data=f,aes(x=long,y=lat,group=id,alpha=0.5))+geom_path(data=mxy, aes(x=x, y=y,col=phi,group=paste(Animal,Track)),size=.5)   + scale_color_continuous(low='blue',high='red') + labs(col="Probability of Foraging")  + theme_inset() 
