...
ggplot(nullhour,aes(x=ccamlr.Unit,y=value)) + geom_violin() + coord_flip() + geom_point(data=ttime_unit,col="red") + theme_bw() + labs(y="Hours") + labs(x="Unit",y="Observation Hours")
```
