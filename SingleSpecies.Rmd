...
#mxy<-mxy[mxy$Animal %in% c("112703","121211","123232","112705","154187"),]
...
```{r,child="Bayesian/Multi_RW.jags"}
```
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=3000,n.burnin=1500,n.thin=2,DIC=FALSE))
}
