...
```{r}
#For convienance we are calling the traveling state as phi above 0.5
mxy$State<-factor(mxy$phi>0.5)
levels(mxy$State)<-c("Foraging","Traveling")

ssy<-split(mxy,mxy$State)
...
plot(r/length(unique(traveling$Animal)))
map(add=T)
```
