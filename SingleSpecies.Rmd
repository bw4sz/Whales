...
```{r}
#Compute angle to the nearest landmass
land<-ice<0
land[land==0]<-NA
distcc<-distance(land)
plot(distcc)
```
...
#single index
splitpc[c("alpha_mu","beta_mu","beta2_mu","beta3_mu","gamma","theta")]<-lapply(splitpc[c("alpha_mu","beta_mu","beta2_mu","gamma","theta")],function(x){
