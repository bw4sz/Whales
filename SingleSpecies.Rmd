...
#grab two animals
mxy<-mxy[mxy$Animal %in% c("131142","131159","131153"),]
...
##Spatial Prediction
```{r}
ggmap(m)+geom_path(data=mxy, aes(x=x, y=y,col=as.factor(Animal),size=.5))
```
...
marrangeGrob(spp,ncol=2,nrow=(length(spp)/2)+1)
```
