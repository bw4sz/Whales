...
#grab set of animals
mxy<-mxy[mxy$Year %in% c(2013,2015,2016) ,]
...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=10000,n.burnin=9800,n.thin=5,DIC=FALSE))
}
