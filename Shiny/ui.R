...
#side bar
  ...
  selectInput("Individual","Individual",c("All",unique(d$Animal))),
  ...
  h3("Contact Us"),
  h4("Ben Weinstein"),p("Ben is a quantitative ecologist at the Marine Mammal Research Center, Oregon State University. Ben enjoys appying new technology to ecology and biodiversity conservation."),
  h4("Ari Friedlaender"),p("Ari is an Assistant Professor at Oregon State University, and has been studying whales for twenty years. Ari can be found out to sea everyday that weather and grant applications allow.")
)