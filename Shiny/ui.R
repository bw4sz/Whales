...
#side bar
  ...
  h3("Contact Us"),
  h4(a("Ben Weinstein",href="https://benweinstein.weebly.com")),p("Ben is a quantitative ecologist at the Marine Mammal Research Center, Oregon State University. Ben enjoys appying new technology to ecology and biodiversity conservation."),
